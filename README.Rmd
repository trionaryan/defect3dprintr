...
a) Run lsd - (this is quite though?!? Do I need to put a series of images on github then? image1 to image100 say)
b) Do some anomaly detection using r-esd (easy and quick)
